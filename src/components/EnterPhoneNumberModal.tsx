...
import { Modal, Text, View, TextInput, Switch, Button, StyleSheet } from 'react-native';
...
const EnterPhoneNumberModal: React.FC<ModalFormProps> = ({ isOpen, onClose, onSubmit }) => {
