...
type ImagePagerScreenNavigationProp = StackNavigationProp<RootStackParamList, 'FolderDetails'>;
type ImagePagerScreenRouteProp = RouteProp<RootStackParamList, 'ImagePagerScreen'>;
...
const ImagePagerScreen: React.FC<ImagePagerScreenProps> = ({ navigation, route }) => {
